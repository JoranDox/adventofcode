        ...
        for ijknum, (ijkx, ijky, ijkz) in enumerate(foundbeacons):
            ...
            # print(depth, ornum, ijknum)
                ...
                if c >= 12:
                    ...
                    if len(scannerqueue) > 1:
                        r = getnextscanner(scannerqueue[1:], foundbeacons | b, (*correctscanners, ijkbeacons), depth+1)
                        if r:
                            return r
                        else:
                        ...
                        return foundbeacons | b
            # else: try another orientation
    # if we get here, we failed
    print("back to depth", depth-1)
    return None

print(getnextscanner(scanners[1:], set(scanners[0]), (scanners[0])))